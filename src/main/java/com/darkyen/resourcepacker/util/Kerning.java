...
public class Kerning {
	...
	public final IntArray resultFirst = new IntArray();
	public final IntArray resultSecond = new IntArray();
	public final IntArray resultAmount = new IntArray();
	...
	private void storeKerningOffset (int firstGlyphCode, int secondGlyphCode, int offset) {
		...
		resultFirst.add(firstGlyphCode);
		resultSecond.add(secondGlyphCode);
		resultAmount.add(value);
	}
